...
export default class Analytics extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="mt-24 px-4 lg:justify-center lg:items-center text-left lg:flex">
        <div className="lg:flex-1">
          <div className="lg:flex-row lg:justify-center">
            <h1 className="text-indigo-600 text-2xl font-bold lg:text-3xl">Data Analytics Solutions</h1>
          </div>
          <div className="lg:flex-row lg:align-middle lg:justify-center font-roboto">
            <div className="py-3 text-left text-gray-600 text-base lg:text-xl w-full lg:w-90">
              <p className="py-2">
                Revolutionize your business with our advanced data analytics solutions. Experience the power of data today.
              </p>
              <div className="py-4 text-left text-gray-600 text-base lg:text-xl w-full lg:w-90">
                <h2 className="text-indigo-600 text-lg font-bold lg:text-2xl mb-2 lg:mb-3">Our Offerings:</h2>
              ...
              <p className="py-2 text-base lg:text-xl">
